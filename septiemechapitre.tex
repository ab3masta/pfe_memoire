...
\begin{figure}[H]
    \centering
    \subfloat[\centering Le pourcentage de la variance préserver par les 10 premières composantes.]{{\includegraphics[width=7cm]{images/chapitre7/pca_features1.png}}}%
    \qquad
    \subfloat[\centering Visualisation en 2D des deux composantes.]{{\includegraphics[width=7cm]{images/chapitre7/features_plot1.png} }}%
...
\begin{figure}[H]
    \centering
    \subfloat[\centering Le pourcentage de la variance préserver par chacune des composantes.]{{\includegraphics[width=7cm]{images/chapitre7/pca_variance_ratio1.png}  }}%
    \qquad
    \subfloat[\centering Visualisation de la composante 0 et 3 parmi les 471.]{{\includegraphics[width=7cm]{images/chapitre7/pca_features_compress1.png} } }%
    %\caption{Dendrogramme}%
\end{figure}
...
\begin{figure}[H]
    \centering
    \subfloat[\centering Les scores des méthodes de liaison.]{{\includegraphics[width=7cm]{images/chapitre7/linkage_method_score1.png}  }}%
    \qquad
    \subfloat[\centering Le dendrogramme du dataset utilisant la méthode de liaison « average ».]{{\includegraphics[width=7cm]{images/chapitre7/dendrogram_of_dataset1.png} } }%
    %\caption{Dendrogramme}%
\end{figure}

\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=0.4]{images/chapitre7/agglo_clusters1.png}
	\end{center}
...
\begin{table}[H]
	...
	2  & 0.37  & 811  & \cellcolor{gray!40} 0.87   &  0.435   & 251  \(\displaystyle \thicksim  \) 833  \\ \hline %\cellcolor{gray!40}
