...
Nous avons utilisé le modèle de Rasch, 2PL et 3PL pour faire l’estimation des paramètres des modèles avec le logiciel Stan en utilisant le code Stan définit dans le chapitre \ref{chap:irt}, sauf le bloc « generated quantities » parce qu’en ajoutant, la taille de modèle ajusté devient déraisonnablement grande du fait qu’on a un grand nombre d’item, de sujet et d’observation. Le code stan pour le modèle de Rasch est :
...
\begin{figure}[H]
	...
	\end{center}
	\captionof{A table beside a figure}
	\label{roc_auc}
\end{figure}
